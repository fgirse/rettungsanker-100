              ...
              >
                ...
                <div className="mt-2 lg:mt-1 ">
                      <p className=" p-3 text-justify text-sm leading-5 text-gray-100 lg:text-[.95rem]">
                        ...
                        <Image src="/LogoLeckerladen.svg" alt="Leckerladen Logo" width={80} height={48} className="inline w-20 h-12 object-contain align-middle" />{' '}
